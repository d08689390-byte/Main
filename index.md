...
<div class="portfolio-container-wrapper">
  ...
  <div style="text-align: center; margin-top: 1.5rem;">
    <div class="profile-frame glitch-hover">
  ...
  <p>Have a development project option or an engineering infrastructure task you want to discuss? Securely message me directly using the transmission form below.</p>
  ...
  <p>Really like my coding works? Support my open-source tools today by deploying a donation platform link:</p>
